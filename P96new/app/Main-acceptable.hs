...
checkCompleted = do
    ...
    when completed $ throwError Completed
...
deduce = do
    ...
    when (null updates) $ throwError NoDeduce
...
fill :: SudokuProcessor Sudoku
fill = do
    (checkCompleted >> core) `catchError` whenCompleted
    gets board
  where
    whenCompleted :: SudokuError -> SudokuProcessor ()
    whenCompleted e = case e of
